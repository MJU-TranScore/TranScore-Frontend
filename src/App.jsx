    ...
    <main className="flex flex-col items-center w-full text-center">
      ...
      <section className="w-full bg-gray-500 py-16 px-4">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-4xl font-extrabold text-white mb-4">당신의 악보를 새롭게 변환해보세요</h1>
          <p className="text-base md:text-lg text-white mb-8">
            간단한 업로드만으로 즉시 키 변경, 가사·멜로디 추출까지!
          </p>
          <button className="px-6 py-3 bg-yellow-400 hover:bg-yellow-500 text-white font-semibold rounded shadow transition">
            지금 시작하기
          </button>
        </div>
      </section>
      ...
      <section className="w-full max-w-4xl py-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-6 border rounded shadow-sm bg-white flex flex-col items-center">
            ...
            <p className="text-gray-600 text-sm">PDF 또는 이미지를 선택하여 업로드하세요.</p>
          </div>
          <div className="p-6 border rounded shadow-sm bg-white flex flex-col items-center">
            <div className="text-2xl font-bold mb-2">2</div>
            <h3 className="text-base font-semibold mb-2">반음 선택</h3>
            <p className="text-gray-600 text-sm">원하는 반음만큼 조정값을 선택합니다.</p>
          </div>
          <div className="p-6 border rounded shadow-sm bg-white flex flex-col items-center">
            <div className="text-2xl font-bold mb-2">3</div>
            <h3 className="text-base font-semibold mb-2">다운로드</h3>
            <p className="text-gray-600 text-sm">변환된 악보를 즉시 다운로드합니다.</p>
          </div>
        </div>
      </section>
      ...
      <footer className="mt-12 text-xs text-gray-400">
        &copy; 2025 TranScore. All rights reserved. 비상업적 이용은 무료로 제공되며, 상업적 이용 및 API 연동 시 별도 라이선스가 필요합니다.
      </footer>
    </main>
  );
}
